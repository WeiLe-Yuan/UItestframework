...
class PySelenium(object):
    ...
    def get_elements(self, css):
        ...
        if by == "id":
            ...
            raise NameError("Please enter the correct targeting elements,'id','name','class','link_text','xpaht','css','tag_name'.")
        return elements
    ...
    def alert_is_present(self):
        ...
        """
        t1 = time.time()
        result = expected_conditions.alert_is_present()(self.driver)
        self.my_print("{0} Judge the alert available, Spend {1} seconds".format(success, time.time() - t1))
        return result
